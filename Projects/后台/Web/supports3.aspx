<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true"
	CodeBehind="supports3.aspx.cs" Inherits="Song.Web.supports3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	<div id="techbanner">
		<div id="techmenu">
			<ul>
				...
				<li class="highlightme">电池组与装配</li>
	...
	<div class="techpagecontainter">
		...
		<div class="techl">
			<div class="pagepath"><a href="index.aspx">首页</a> / <a href="supports.aspx">技术支持</a> / 电池组</div>
    <div>
      <div class="pagetitle"> 电池组(CFP型号电池组装配)</div>
				<%=Maticsoft.Common.webcommand.GetInfo(204,1) %>
			</div>
		</div>
	</div>
</asp:Content>
