		...
		{ %>
					<table class="tablecss1">
						...
						<tr>
							...
							<td>
								<textarea name="Textarea2" id="Textarea2" style="display: none" runat="server"></textarea>
								<iframe src="dafckbo/editor/fckeditor.html?InstanceName=Textarea2&Toolbar=Default"
					...
					<table border="1" cellspacing="0" cellpadding="0" class="tablecss1" bordercolor="#eae3e4">
						<tr>
							<td style="height: 30px" colspan="5" class="tabletop">
								类别管理 <a href="#" onclick="history.back()">返回上一页</a>
							</td>
						</tr>
						<tr>
							<td colspan="5">
										...
										<ItemTemplate>
											<tr>
												...
												<td width="80" align="center">
													<a href="ProductsInfo.aspx?pid=<%=pid %>&topid=<%# Eval("id") %>">子类</a>
												</td>
						...
						<tr>
							<td colspan="5">
								名称：<asp:TextBox ID="typename" runat="server" Width="150px"></asp:TextBox>&nbsp;<asp:RequiredFieldValidator
									...
									ValidationGroup="add" ErrorMessage="名称（中）不能为空！"></asp:RequiredFieldValidator><br />
								<div style="display: none">
									名称（英）：<asp:TextBox ID="enname" runat="server" Width="150px"></asp:TextBox>
								</div>
								<br />
								<span>图片：<asp:FileUpload ID="FileUpload1" runat="server" /></span> &nbsp;<asp:ValidationSummary
									ValidationGroup="add" ShowMessageBox="true" ShowSummary="false" ID="ValidationSummary1"
									runat="server" />
								<br />
								<br />
								<span>关键字：<textarea name="key1" id="key1" runat="server" style="width: 500px; height: 100px;"></textarea></span>
								<br />
								<br />
								<span>描述：
									<textarea name="key2" id="key2" style="display: none" runat="server"></textarea>
									<iframe src="dafckbo/editor/fckeditor.html?InstanceName=key2&Toolbar=Default" frameborder="no"
										scrolling="no" class="i1" height="400" width="100%"></iframe>
								</span>
								<br />
								<br />
