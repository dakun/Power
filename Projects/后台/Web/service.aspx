<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true"
	CodeBehind="service.aspx.cs" Inherits="Song.Web.service" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div class="center">
		<div id="sercontl">
			<div class="servframe">
				<div class="pathhere">
					<a href="index.aspx">首页</a> / 客户服务 / 在线反馈/咨询</div>
				<div class="txttil">
					在线反馈/咨询</div>
				...
				<div class="pTabPageBord">
					...
					<div style="padding-top: 30px; text-align: center">
						<asp:Button ID="sendf" runat="server" Text="&nbsp;&nbsp;发送信息&nbsp;&nbsp;" name="sendf"
							title="点击提交留言" OnClick="sendf_Click" />
						<input type="button" name="setinfo" id="setinfo" value="&nbsp;&nbsp;清除全部&nbsp;&nbsp;"
			...
			<div class="servframe">
				<div class="pathhere">
					<a href="index.aspx">首页</a> / 客户服务 / 联系我们</div>
				<div class="txttil">
					联系我们</div>
				<%=Maticsoft.Common.webcommand.GetInfo(194,1) %>
			</div>
			<div class="servframe">
				<div class="pathhere">
					<a href="index.html">首页</a> / 客户服务 / 文件下载</div>
				<div class="txttil">
					文件下载</div>
				<%--<p>
